(function() {
   $("#form-left").click(function (e) {
        ...
        $("#left-title").css("color","RGB(45,150,205)");
        if($("#list1").css("border-bottom-width")==='0px'){
            ...
            $("#list1").css("border-color","#2d96cd");
        }else{
            $("#list1").css("border-bottom","none");
            $("#list3").css("border-top","none");
            $("#list1").css("border-color","RGB(169,169,169)");
        }
        e.stopPropagation();
    })
    ...
    $("#form-right").click(function (e) {
        ...
        $("#list1").css("border-color","RGB(169,169,169)");
        $("#left-title").css("color","RGB(136,136,136)")
        $("#right-title").css("color","#2d96cd");
        if($("#list2").css("border-bottom-width")==='0px'){
            ...
            $("#list2").css("border-color","#2d96cd");
        }else{
            $("#list2").css("border-bottom","none");
            $("#list4").css("border-top","none");
            $("#list2").css("border-color","RGB(169,169,169)");
        }
        e.stopPropagation();
    })
